...
function exercici4() {
    var nom = ["F", "E", "R", "R", "A", "N"];
    var cognom = ["F", "U", "S", "A", "L", "B", "A"];

    var nomComplet = nom.concat(" ", cognom);
...
function nivell2() {
    ...
    //Regex
    var regex = str.match(/[a-zñA-ZÑ0-9-_.]+@[a-zñA-ZÑ0-9-_.]+[a-zñA-ZÑ]/gi);

    //Filtro para eliminar emails duplicados
    var filter = regex.filter(function(value, index) { return regex.indexOf(value) == index });
